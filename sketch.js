...
let concepts = [
  ...
  "generative design", "mindfulness", "communities", "social networks", 
  "generativity", "governance", "ethics", "care", "Web3", "performance",
   "open pedagogies", "installations", 'interdisciplinary'
];
